...
export default function OurDrone() {
  return (
    <>
    <div className="bg-[radial-gradient(circle,rgba(245,245,245,1) 10%,rgba(200,200,200,1) 40%,rgba(30,30,30,1) 90%)] flex flex-col items-center px-6 py-16">
      
      {/* Section Title */}
      <h1 className="text-5xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-gray-500 to-gray-900 mb-8 underline">
        Our Drone
      </h1>

      {/* Description */}
      <p className="max-w-3xl text-center text-black text-xl font-normal">
      ...
      {/* Breakdown Section */}
      <div className="bg-black min-h-[20px] p-10 w-[100vw]">

      <div className="max-w-5xl grid grid-cols-1 md:grid-cols-2 bg-black gap-8 mx-auto">
  {[
    {
